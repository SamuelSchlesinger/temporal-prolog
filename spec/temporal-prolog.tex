...
the whole source program on a violation.
...
assertions and model-checking input choices.
...
\begin{enumerate}
  ...
  reject every shared negative case.  Rejections include inconsistent symbol
  arities, malformed pattern-function relational forms, malformed external
  operation signatures, and external predicates used as results or asserted
  world facts.
