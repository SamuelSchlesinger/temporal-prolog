...
\begin{enumerate}
  ...
  arities, non-ASCII identifiers, malformed pattern-function relational forms,
  malformed external operation signatures, and external predicates used as
  results or asserted world facts.  Positive cases exercise contextual keyword
  reservation across predicate and constructor namespaces.  Runtime rejection
